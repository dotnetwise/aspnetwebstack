...
namespace System.Web.Helpers
{
    public static class Crypto
    {
        ...
        internal static byte[] GenerateSaltInternal(int bytesLength = SaltSize)
        {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1720:IdentifiersShouldNotContainTypeNames", MessageId = "byte", Justification = "It really is a byte length")]
        public static string GenerateSalt(int bytesLength = SaltSize)
        {
            return Convert.ToBase64String(GenerateSaltInternal(bytesLength));
        }
